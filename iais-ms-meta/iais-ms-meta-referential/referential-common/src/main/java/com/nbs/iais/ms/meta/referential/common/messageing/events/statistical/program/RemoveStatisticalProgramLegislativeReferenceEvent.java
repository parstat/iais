...
public class RemoveStatisticalProgramLegislativeReferenceEvent extends AbstractEvent<StatisticalProgramDTO> {

    private static final long serialVersionUID = 200L;

    public RemoveStatisticalProgramLegislativeReferenceEvent() {
        super();
    }
}
