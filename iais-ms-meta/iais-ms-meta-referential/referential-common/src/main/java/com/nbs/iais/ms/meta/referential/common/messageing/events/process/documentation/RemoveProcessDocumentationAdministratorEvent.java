...
public class RemoveProcessDocumentationAdministratorEvent extends AbstractEvent<ProcessDocumentationDTO> {

    private static final long serialVersionUID = 200L;

    public RemoveProcessDocumentationAdministratorEvent() {
        super();
    }
}
