...
public class RemoveProcessDocumentationInputCommand extends AbstractCommand<RemoveProcessDocumenationInputEvent> {
    ...
    private RemoveProcessDocumentationInputCommand(final String jwt, final Long documentation, final Long input) {
        super(new RemoveProcessDocumenationInputEvent());
        setJwt(jwt);
        this.input = input;
    ...
    public static RemoveProcessDocumentationInputCommand create(final String jwt, final Long documentation, final Long input) {
        return new RemoveProcessDocumentationInputCommand(jwt, documentation, input);
    }
