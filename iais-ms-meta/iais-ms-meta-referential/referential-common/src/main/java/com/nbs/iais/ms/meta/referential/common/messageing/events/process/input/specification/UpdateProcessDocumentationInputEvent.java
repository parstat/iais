...
public class UpdateProcessDocumentationInputEvent extends AbstractEvent<ProcessDocumentationDTO> {

    private static final long serialVersionUID = 20112520L;

    public UpdateProcessDocumentationInputEvent() {
        super();
    }
